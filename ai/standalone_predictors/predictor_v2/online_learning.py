...
from predictor_v2 import config as cfg, csv_loader, deep_model, tracking_engine
...
def synchronize_with_latest_actual(draws, config_payload):
    ...
    fine_tune_result = deep_model.incremental_fine_tune(last_prediction, actual_draw)
    ...
    return {
        ...
        "message": "Đã cập nhật predictor_v2 sau khi kỳ thật mới xuất hiện.",
    }
